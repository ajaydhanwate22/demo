...
const UserDataLifeTime = ({ navigation}) => {

    const data = [{ id: 1, Kw: '255' },{ id: 2, Kw: '204' },{ id: 3, Kw: '153'},{ id: 4, Kw: '102' },{ id: 5, Kw: '51'},{ id: 6, Kw: '0.0'}];

      const Hours = [{ id: 1, Hr: '2024'},{ id: 2, Hr: '2025'}];
            ...
            <View style={{flexDirection:'row', justifyContent:'space-between',backgroundColor: 'rgb(243, 238, 238)', paddingVertical:5, paddingHorizontal:10}}>
                  ...
                  <TouchableOpacity style={{flexDirection:'row', justifyContent:"center", alignItems:"center", gap:10}}>
                      <AntDesign name="calendar" size={20} color="black" />
                            <Text style={styles.Text}>2020-2025</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={{justifyContent:"center", alignItems: 'center'}}>
                   ...
                   <View style={{gap:1}}>
                       ...
                       <View style={{gap:1}}>
                           <TouchableOpacity style={{flexDirection:'row', justifyContent:"center", alignItems:'center', gap:5, flex:1}}>
                               ...
                               <Text style={{fontSize:8}} >Export</Text>
                           </TouchableOpacity>
                       </View>
                       <View style={{gap:1}}>
                           <TouchableOpacity style={{flexDirection:'row', justifyContent:"center", alignItems:'center', gap:5, flex:1}}>
                               <View style={{width: 8,height: 8,backgroundColor: 'green',alignSelf:'center'}}></View>
                               <Text style={{fontSize:8}} >charged</Text>
                           </TouchableOpacity>
                       </View>
                       <View style={{gap:1}}>
                           <TouchableOpacity style={{flexDirection:'row', justifyContent:"center", alignItems:'center', gap:5, flex:1}}>
                               <View style={{width: 8,height: 8,backgroundColor: 'orange',alignSelf:'center'}}></View>
...
export default UserDataLifeTime;
