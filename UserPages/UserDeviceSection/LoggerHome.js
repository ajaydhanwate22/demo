            ...
            <SafeAreaView style={styles.PageContainer}>
                <ScrollView>
                    <View style={{paddingVertical:10}}>
                        <Text>Logger Quantity: 1</Text>
                    </View>
                    <TouchableOpacity style={{paddingVertical:20, paddingHorizontal:10, backgroundColor:'white', borderBottomWidth:0.3,borderColor:'lightgrey'}}onPress={() => navigation.navigate('LoggerMainPage')}>
                        <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center'}}>
                             <View style={{flexDirection:"row",justifyContent:'center', alignItems:'center',gap:5}}>
                                <Text><Entypo name='circle-with-minus' size={18} color='#f01a05' /></Text>
                                <Text style={{textAlign:'center'}}>Logger</Text>
                            </View>
                            <View style={{flexDirection:"row",justifyContent:'center', alignItems:'center',gap:5}}>
