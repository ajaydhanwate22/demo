...
const OverViewLifetime = ({ navigation}) => {

    const data = [{ id: 1, Kw: '300' },{ id: 2, Kw: '200' },{ id: 3, Kw: '100' },{ id: 4, Kw: '0'},{ id: 5, Kw: '-100' },{ id: 6, Kw: '-200'},{ id: 7, Kw: '-300' }];
    ...
    <>
            ...
            <View style={{paddingHorizontal:10}}>
                <View style={{flexDirection:"row"}}>
                    ...
                    <Text style={{fontSize:10}}>2024</Text>
                </View>
...
export default OverViewLifetime;
