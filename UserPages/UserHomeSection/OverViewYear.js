...
const OverViewYear = ({ navigation}) => {

    const data = [{ id: 1, Kw: '60'},{ id: 2, Kw: '40' },{ id: 3, Kw: '20' },{ id: 4, Kw: '0'},{ id: 5, Kw: '-20'},{ id: 6, Kw: '-40'},{ id: 7, Kw: '-60'}];
    ...
    <>
            ...
            <View style={{paddingHorizontal:10}}>
                <View style={{flexDirection:"row"}}>
                    ...
                    <Text style={{fontSize:10}}>2025-01</Text>
                </View>
