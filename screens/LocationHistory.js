        ...
        <SafeAreaView style={styles.PageContainer}>
            <ScrollView>
                ...
                <View style-={{ width:'100%',}}>
                    <TouchableOpacity onPress={() => navigation.navigate('ProfileUpdate')} style={{paddingHorizontal:30, borderBottomWidth:1 ,paddingVertical:15}}> 
                        <Text style={{ fontSize:14, fontWeight:600}}>Profile Update</Text>
                    </TouchableOpacity >
                    <TouchableOpacity onPress={() => navigation.navigate('Requestforadvanced')}  style={{paddingHorizontal:30, borderBottomWidth:1 ,paddingVertical:15}}> 
                        <Text style={{ fontSize:14,fontWeight:600}}>Request For Advanced</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('CheckAttendence')}  style={{paddingHorizontal:30, borderBottomWidth:1 ,paddingVertical:15}}> 
                        <Text style={{fontSize:14,fontWeight:600}}>Check Attendance</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('LocationReport')}  style={{paddingHorizontal:30, borderBottomWidth:1 ,paddingVertical:15}}> 
                        <Text style={{fontSize:14,fontWeight:600}}>Location Reports</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{paddingHorizontal:30, borderBottomWidth:1 ,paddingVertical:15}}> 
                        <Text style={{fontSize:14,fontWeight:700}}></Text>
                    </TouchableOpacity>
                </View>

                {/* <Pressable style={{ width: "90%", height: 100, alignSelf: "center", borderWidth: 1, justifyContent: "center", alignItems: "center", borderRadius: 5, marginTop:20 }}>
                    <Text style={{ fontSize: 12, color: "#000", fontWeight: "500" }}>Day start time:  9.30 PM</Text>
                    <Text style={{ fontSize: 12, color: "#000", fontWeight: "500" }}>  Dte : 5/12/2024</Text>
                    <TouchableOpacity onPress={getLocation} style={{ width: "70%", height: 40, borderRadius: 50, backgroundColor: "#01a30c", justifyContent: "center", alignItems: "center", marginTop: 5 }}>
                        <Text style={{ fontSize: 16, fontWeight: "700", color: "#fffffe" }}>Update location </Text>
                    </TouchableOpacity>
                </Pressable> */}
                ...
                {location ? (
                    ...
                    !loading && <Text style={{paddingLeft:20}}>No location data available.</Text>
                )} */}
                

                {/* <Pressable style={{ width: "90%", alignSelf: "center", height: 40, justifyContent: "center" }}>
                    <Text style={{ fontSize: 12, fontWeight: "700", color: "#01a30c" }}>Location History </Text>
                </Pressable> */}
  ...
  const formatDate = (dateString) => {
    ...
    return `${day}/${month}/${year}`;
                        ...
                        return (
                            ...
                            // <Pressable key={index} style={{ width: "90%", alignSelf: "center", height: 70, borderBottomWidth: 1, justifyContent: "center" }}>
                            //     <Text style={{ fontSize: 12, fontWeight: "800", color: "#000" }}>{item.city} - {item.pincode}, {item.district} - {item.state}</Text>
                            //     <Text style={{ fontSize: 12, fontWeight: "500", color: "#000" }}>Time : {convertTo12Hour(item.times)}</Text>
                            //     <Text style={{ fontSize: 12, fontWeight: "500", color: "#000" }}>Date : {formatDate(item.dates)}</Text>
                            // </Pressable>
