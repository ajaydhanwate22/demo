...
const PurchasePayPayment = ({navigation}) => {
    const payments =[
        { id: 1, title: 'Kohinnoor Enterprises', amount: 40000, date: '16/01/2025' }, 
        { id: 2, title: 'Kohinnoor Enterprises', amount: 40000, date: '16/01/2025' }, 
        { id: 3, title: 'Kohinnoor Enterprises', amount: 40000, date: '16/01/2025' }];
  ...
  <SafeAreaView style={styles.PageContainer}>
    ...
    <TouchableOpacity onPress={() => navigation.goBack()}>
        ...
        <Text style={{color: "#f01a05",textAlign:"center", justifyContent:"center", fontWeight:"bold", fontSize:19.1}}>Purchase Pay Payment </Text>
        </View>
    </View>
                    ...
                    <View style={{paddingHorizontal:30}}>
                        <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'flex-start',gap:15, marginTop:20,marginBottom:10}} >  
                          ...
                          <Entypo name="plus" size={22} color="#f01a05" style={{backgroundColor:"#f2be25", borderRadius:25}} />
                            ...
                            <Text style={{ fontSize: 14,  color: "#000000", justifyContent:"center", textAlign:"center"}}>Add Purchase Pay Payment</Text>
                        </View>
                        ...
                        <View style={{flexDirection:"row", justifyContent:"space-between", marginBottom:10}}> 
                          <Text style={{fontSize:12, color:"#f01a05"}}>Given Amount: ₹ {payment.amount}</Text>
                          <Text style={{fontSize:12, color:"#f01a05"}}>Date: {payment.date}</Text>
                                            ...
                                            {/* modal */}
                                                  ...
                                                  <View style={{justifyContent: "center",alignItems:"center" }}>
                                                      <Text style={{ fontSize: 18, color: "#f01a05", fontWeight: "bold", textAlign:"center" }}>Add  Purchase Pay Payment</Text>
                                                  </View>
...
export default PurchasePayPayment
