...
const RequiredMaterial = ({ navigation } ) => {

  
const tableData = [
  { srNo: 1, material: 'Solar panel', quantity: '12 pieces' },
  { srNo: 2, material: 'Solar panel', quantity: '12 pieces' },
];
            ...
            <ScrollView>
                ...
                <TouchableOpacity style={{ width: "100%", height: 40, overflow: "hidden", alignSelf: "center" }}>
                    <LinearGradient colors={['#ffde59', '#ff914d']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={{ width: "100%", height: "100%", display: "flex", flexDirection: "row", justifyContent: "space-evenly", alignItems: "center" }} >
                          <Text style={{ fontSize: 19.1, color: "#000", fontWeight: "bold" }}>Required Material</Text>
                      </LinearGradient>
                </TouchableOpacity>
                  ...
                  <View style={{ marginTop:20, borderBottomWidth: 0.3, borderColor: '#343341',}}>
                    ...
                    <View style={{ flexDirection: 'row', width: '100%', backgroundColor:'#f2be25' }} >
                      <View style={{ width: '20%', alignItems: 'center', borderRightWidth: 0.3, borderColor: '#343341', paddingVertical: 8 }}>
                        <Text style={{ fontSize: 17, color: "#000000",fontWeight:'bold',  }}> Sr.No</Text>
                      </View>
                      ...
                      <View style={{ width: '38%', alignItems: 'center', borderRightWidth: 0.3, borderColor: '#343341', paddingVertical: 8 }}>
                    ...
                    {tableData.map((row, index) => (
                      <View  key={index} style={{ flexDirection: 'row',width: '100%', justifyContent: 'flex-start',backgroundColor: index % 2 === 0 ? '#e7e7e7' : 'white', // Alternate row background color
                        }} >
                        <View style={{ width: '20%', alignItems: 'center', borderRightWidth: 0.3, borderColor: '#343341', paddingVertical: 10 }}>
                          <Text style={{ fontSize: 15, color: "#000000" }}>{row.srNo}</Text>
                        </View>
                        <View style={{ width: '42%', alignItems: 'center', borderRightWidth: 0.3, borderColor: '#343341', paddingVertical: 10 }}>
                          <Text style={{ fontSize: 15, color: "#000000" }}>{row.material}</Text>
                        </View>
                        <View style={{ width: '38%', alignItems: 'center', borderRightWidth: 0.3, borderColor: '#343341', paddingVertical: 10 }}>
                          <Text style={{ fontSize: 15, color: "#000000" }}>{row.quantity}</Text>
                        </View>
                      </View>
                    ))} 
                  </View>
                ...
                <Pressable style={{ width: "100%", height: 70, justifyContent: "center", alignItems: "center", backgroundColor: "#ffffff", elevation: 3 }}>
                    <TouchableOpacity style={{ width: "90%", height: 50, backgroundColor: "#f2be25", borderRadius: 6, justifyContent: "center", alignItems: "center" }} onPress={showStartModal}>
                      ...
                      <Text style={{ fontSize: 15, fontWeight: "700", color: "#000000", alignSelf:"center" }}>Add Required Material</Text>
                      </View>
                    </TouchableOpacity>
                </Pressable>
                ...
                <Modal visible={StartVisible} style={{ width: "100%", height: "100%", backgroundColor: "#000" }}>
                                    ...
                                    <View style={{justifyContent: "center",alignItems:"center" }}>
                                        <Text style={{ fontSize: 19, color: "#f01a05", fontWeight: "bold", textAlign:"center" }}>Add Required Material</Text>
                                    </View>
