...
const TeaCoffeeBill = ({ navigation } ) => {

  const [items, setItems] = useState([
    { srNo: 1, name: 'Coffee', cost: '₹ 200' },
    { srNo: 2, name: 'Coffee', cost: '₹ 200' },
    { srNo: 3, name: 'Coffee', cost: '₹ 200' },
  ]);
  ...
  return (
    <SafeAreaView style={styles.PageContainer}>
        ...
        {/* page container */}
           <TouchableOpacity style={{ width: "100%", height: 40, overflow: "hidden", alignSelf: "center" }}>
                  <LinearGradient colors={['#ffde59', '#ff914d']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={{ width: "100%", height: "100%", display: "flex", flexDirection: "row", justifyContent: "space-evenly", alignItems: "center" }} >               
                       <Text style={{ fontSize: 19.1, color: "#000", fontWeight: "bold" }}>Tea Coffee Bill</Text>
                  </LinearGradient>
           </TouchableOpacity>
      ...
      {/* Table Content */}
      {items.map((item, index) => (<View key={item.srNo} style={{ flexDirection: 'row',  width: '100%', justifyContent: 'flex-start',
          ...
          <View style={{ width: '30%', alignItems: 'center', paddingVertical: 10, justifyContent: 'space-around', flexDirection: 'row' }}>
          ...
          <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'flex-end',paddingVertical: 10, paddingRight:20,gap:5  }} >
               <Text style={{ fontSize: 16, fontWeight: "700", color: "#000000",}}>Total:</Text>
              <Text style={{ fontSize: 16, fontWeight: "700", color: "#000000"}}>₹ 600</Text>
        </View>
    </ScrollView>
