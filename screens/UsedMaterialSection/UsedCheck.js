...
const UsedCheck = ({ navigation } ) => {

  const materials = [
    { srNo: 1, material: 'Solar panel', quantity: '12 pieces', status: 'check-circle' },
    { srNo: 2, material: 'Solar panel', quantity: '12 pieces', status: 'check-circle' },
    { srNo: 3, material: 'Solar panel', quantity: '12 pieces', status: 'check-circle' },
    { srNo: 4, material: 'Solar panel', quantity: '12 pieces', status: 'check-circle' },
    { srNo: 5, material: 'Solar panel', quantity: '12 pieces', status: 'check-circle' },
    { srNo: 6, material: 'Solar panel', quantity: '12 pieces', status: 'check-circle' }
  ];
  ...
  return (
    <SafeAreaView style={styles.PageContainer}>
        ...
        {/* page container */}
           <TouchableOpacity style={{ width: "100%", height: 40, overflow: "hidden", alignSelf: "center" }}>
                  <LinearGradient colors={['#ffde59', '#ff914d']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={{ width: "100%", height: "100%", display: "flex", flexDirection: "row", justifyContent: "space-evenly", alignItems: "center" }} >               
                       <Text style={{ fontSize: 19.1, color: "#000", fontWeight: "bold" }}>Use Check Material</Text>
                  </LinearGradient>
           </TouchableOpacity>
      ...
      {materials.map((item, index) => (
        <View  key={item.srNo} style={{ flexDirection: 'row', width: '100%', justifyContent: 'flex-start', backgroundColor: index % 2 === 0 ? '#e7e7e7' : 'transparent'}}>
          ...
          <View style={{ width: '38%', alignItems: 'center', borderRightWidth: 0.3, borderColor: '#343341', paddingVertical: 10, justifyContent: 'space-between', flexDirection: 'row', paddingHorizontal: 20 }}>
            ...
            <FontAwesome name={item.status} size={25} color="#01a30c" />
          </View>
        </View>
           ))} 
    </View>
                ...
                <Pressable style={{ width: "100%", height: 70, justifyContent: "center", alignItems: "center", backgroundColor: "#ffffff", elevation: 3 }}>
                    <TouchableOpacity style={{ width: "90%", height: 50, backgroundColor: "#f2be25", borderRadius: 6, justifyContent: "center", alignItems: "center" }} onPress={showStartModal}>
                      ...
                      <Text style={{ fontSize: 15, fontWeight: "700", color: "#000000", alignSelf:"center" }}>Add Checked Material</Text>
                      </View> 
                    </TouchableOpacity>
                </Pressable>
            ...
            <Modal visible={StartVisible} style={{ width: "100%", height: "100%", backgroundColor: "#000" }}>
                                    ...
                                    <View style={{justifyContent: "center",alignItems:"center" }}>
                                        <Text style={{ fontSize: 18, color: "#f01a05", fontWeight: "bold", textAlign:"center" }}>Add  Checked Material</Text>
                                    </View>
